...
class ParameterizedConnectionsGenerator extends ConnectionsGenerator {
    constructor(region, routes) {
        ...
        this.param_route_choice_power = 2; // Higher values means higher chance on larger routes when selecting routes
        this.param_time_choice_power = 3; // Higher values means higher chance on more frequent times when selecting times
        this.param_vehicle_max_speed = 160; // km/h
        this.param_vehicle_speedup = 5000; // km/(h^2)
        ...
        this.param_hourly_weekday_distribution = [
            0.05,
            0.01,
            0.01,
            0.48,
        ...
        this.param_hourly_weekend_distribution = [
            0.09,
            0.01,
            0.01,
            0.08,
    ...
    getRandomInitialTime() {
        ...
        var time = this.param_time_final + Math.floor(this.random() * timeRange);
    ...
    generate() {
        ...
        while (this.connections.length < this.param_connections) {
            ...
            route.trips.forEach(trip => {
                ...
                toAddConnections.push({ departureTime: initial, arrivalTime: initial + duration, trip: trip });
