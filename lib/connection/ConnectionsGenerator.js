...
class ConnectionsGenerator {
    ...
    addConnection(trip, departureTime, arrivalTime, delayDeparture, delayArrival, delayDepartureReason, delayArrivalReason, connectionSequenceId, stopSequence){
        this.connections.push({ tripId: trip.tripId, departureTime: departureTime, arrivalTime: arrivalTime, trip: trip,
            delayDeparture: delayDeparture, delayArrival: delayArrival, delayDepartureReason: delayDepartureReason,
            delayArrivalReason: delayArrivalReason, connectionSequenceId: connectionSequenceId, stopSequence: stopSequence });
    }
