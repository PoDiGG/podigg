...
class ParameterizedEdgesGenerator extends EdgesGenerator {
    constructor(region, config) {
        ...
        this.param_post_cluster_max_intracluster_distancefactor = Config.value(config, 'post_cluster_max_intracluster_distancefactor', 1.5); // Maximum distance clusters can have in the post step. The larger the value, the larger the chance that a cluster will be connected to more clusters.
