        ...
        this._writeCsvData(path, writer => {
            this.routes.forEach(route => {
                writer.write({
                    ...
                    trip_id: this.param_seed_start + "_" + route.routeId
                });
            });
        });
    }
        ...
        this._writeCsvData(path, writer => {
            this.connections.forEach(connection => {
                ...
                var writeForStop = (stop, i) => {
                    ...
                    if (!writtenTimes[key]) {
                        writer.write({
                            trip_id: this.param_seed_start + "_" + route_id,
                    ...
                    delivered_dates[route_id][arrivalTime.getFullYear() + "" + this._prefixZero(arrivalTime.getMonth() + 1) + "" + this._prefixZero(arrivalTime.getDate() + 1)] = true;
                };
