...
class ParameterizedRoutesGenerator extends RoutesGenerator {
    constructor(region, edges, config) {
        ...
        this.param_routes = Config.value(config, param_scope + 'routes', 1000); // The number of routes to generate
        this.param_largest_stations_fraction = Config.value(config, param_scope + 'largest_stations_fraction', 0.25); // The fraction of (largest) stations inbetween which routes need to be formed.
